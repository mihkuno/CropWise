...
<div class="max-w-lg m-auto flex flex-col gap-8 items-center justify-center py-14">
    ...
    <div class="flex gap-2 w-full">
            <div class="flex items-center gap-2 px-4.5 py-2.5 rounded- font-semibold bg-white rounded-2xl shadow-2xl cursor-pointer hover:opacity-90">
                <Globe size="20" />
                <p class="text-sm">English</p>a
            </div>
            <div class="flex items-center gap-2 px-4.5 py-2.5 rounded- font-semibold bg-white rounded-2xl shadow-2xl cursor-pointer hover:opacity-90">
                <History size="20" />
    ...
    <div class="flex flex-col gap-4 p-6 bg-white/50 rounded-xl shadow-2xl w-full">
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex items-center p-4 bg-[#f3eee6] rounded-xl border-2 border-[#e8e3d9]">
                <span class="text-5xl mr-3.5">🌾</span>
                <div>
                    <p class="font-semibold mb-1">Kalinawan Farm</p>
                    <p>12.5 hectares • Clay-loam soil</p>
            ...
            <div class="flex items-center p-4 bg-[#f3eee6] rounded-xl border-2 border-[#e8e3d9]">
                <span class="text-5xl mr-3.5">🥕</span>
                <div>
                    <p class="font-semibold mb-1">Malasag Organic Farm</p>
                    <p>8.2 hectares • Sandy-loam soil</p>
    ...
    <div class="flex items-center justify-center p-4 w-full bg-[#84c059] rounded-3xl shadow-2xl gap-2 cursor-pointer hover:opacity-90">
...
<div class="flex flex-col gap-4 p-6 bg-white/70 backdrop-blur-md rounded-2xl shadow-xl w-full">
    ...
    <div class="flex flex-col gap-4 p-6 bg-white/70 backdrop-blur-md rounded-2xl shadow-xl w-full">
        ...
        <!-- tomato -->
        <div class="flex flex-col border-2 border-[#e8e3d9] rounded-xl p-4 gap-4 bg-[#f3eee6]">
            <!-- Left: Icon + Name -->
            <div class="flex items-center gap-3">
                <span class="text-6xl">🍅</span>
                <div class="flex justify-between items-center w-full">
                    <p class="font-semibold text-xl">Tomato</p>
                    <span class="text-xs bg-black text-white px-2 py-1.5 rounded-lg w-fit">Fruit Vegetable</span>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-3">
                ...
                <p class="text-sm text-gray-700 leading-snug">
                    Thrives in clay-loam soil with good drainage. High potassium supports fruit development. 
                    Current weather pattern ideal for transplanting.
                </p>

                <!-- Quick Facts (grid instead of stacked) -->
                <div class="grid grid-cols-2 gap-y-1 gap-x-4 text-sm">
                    <p><span class="font-semibold">🌱 Growth:</span> 75-85 days</p>
                    <p><span class="font-semibold">💧 Water:</span> Moderate</p>
                    <p><span class="font-semibold">📏 Spacing:</span> 60cm apart</p>
                    <p><span class="font-semibold">☀️ Season:</span> Year-round</p>
                    <p><span class="font-semibold">🧪 pH:</span> 6.0-7.0</p>
                    <p><span class="font-semibold">🥕 Yield:</span> 2-3 kg/plant</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col border-2 border-[#e8e3d9] rounded-xl p-4 gap-4 bg-[#f3eee6]">
            ...
            <div class="flex items-center gap-3">
                <span class="text-6xl">🍆</span>
                <div class="flex justify-between items-center w-full">
                    <p class="font-semibold text-xl">Eggplant</p>
                    <span class="text-xs bg-black text-white px-2 py-1.5 rounded-lg w-fit">Fruit Vegetable</span>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-3">
                <!-- Description -->
                <p class="text-sm text-gray-700 leading-snug">
                    Excellent nitrogen uptake matches your soil profile. Heat-tolerant variety perfect for current season. Good rotation crop after rice.
                </p>

                <!-- Quick Facts (grid instead of stacked) -->
                <div class="grid grid-cols-2 gap-y-1 gap-x-4 text-sm">
                    <p><span class="font-semibold">🌱 Growth:</span> 70-80 days</p>
                    <p><span class="font-semibold">💧 Water:</span> Moderate - High</p>
                    <p><span class="font-semibold">📏 Spacing:</span> 45cm apart</p>
                    <p><span class="font-semibold">☀️ Season:</span> Dry-Wet Transition</p>
                    <p><span class="font-semibold">🧪 pH:</span> 6.5-7.5</p>
                    <p><span class="font-semibold">🥕 Yield:</span> 1.5-2 kg/plant</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col border-2 border-[#e8e3d9] rounded-xl p-4 gap-4 bg-[#f3eee6]">
            ...
            <div class="flex items-center gap-3">
                <span class="text-6xl">🌱</span>
                <div class="flex justify-between items-center w-full">
                    <p class="font-semibold text-xl">Okra</p>
                    <span class="text-xs bg-black text-white px-2 py-1.5 rounded-lg w-fit">Pod Vegetable</span>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-3">
                <!-- Description -->
                <p class="text-sm text-gray-700 leading-snug">
                    Low phosphorus requirement suits your soil. Drought-resistant backup for dry spells. Fast-growing summer crop.
                </p>

                <!-- Quick Facts (grid instead of stacked) -->
                <div class="grid grid-cols-2 gap-y-1 gap-x-4 text-sm">
                    <p><span class="font-semibold">🌱 Growth:</span> 50-65 days</p>
                    <p><span class="font-semibold">💧 Water:</span> Low - Moderate</p>
                    <p><span class="font-semibold">📏 Spacing:</span> 30cm apart</p>
                    <p><span class="font-semibold">☀️ Season:</span> Hot/Dry Season</p>
                    <p><span class="font-semibold">🧪 pH:</span> 6.0-8.0</p>
                    <p><span class="font-semibold">🥕 Yield:</span> 0.8-1.2 kg/plant</p>
                </div>
            </div>
        </div>
